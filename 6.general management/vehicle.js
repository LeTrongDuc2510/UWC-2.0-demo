...
var flag=1;
const image=[
  "./imageVehicle/image1.jpeg",
  "./imageVehicle/image2.jpeg",
  "./imageVehicle/image3.png",
  "./imageVehicle/image4.jpeg",
  "./imageVehicle/image5.jpeg"
]
/* Show Table */
...
changeblock1=function(){
  ...
  document.querySelector("#image").src=image[0];
...
changeblock2=function(){
  ...
  document.querySelector(".content-on-txt").innerHTML="Đang hoạt động";
  document.querySelector("#image").src=image[1];
  colorBox=document.querySelector(".content-color-box");
  colorBox.style.background="red";
  document.querySelector(".content-route").classList.remove("hidden");
  document.querySelector(".content-d1").style.display="block";
...
changeblock3=function(){
  ...
  document.querySelector("#image").src=image[2];
  colorBox=document.querySelector(".content-color-box");
...
changeblock4=function(){
  ...
  document.querySelector(".content-on-txt").innerHTML="Đang hoạt động";
  document.querySelector("#image").src=image[3];
  colorBox=document.querySelector(".content-color-box");
  colorBox.style.background="red";
  document.querySelector(".content-route").classList.remove("hidden");
  document.querySelector(".content-d1").style.display="block";
...
const changeblockRandom=function(number){
  flag=number;
  var rand = Math.floor(Math.random() * Object.keys(image).length);
  ...
  document.querySelector(".content-on-txt").innerHTML="Đang hoạt động";
  document.querySelector("#image").src=image[rand];
  colorBox=document.querySelector(".content-color-box");
  colorBox.style.background="red";
  document.querySelector(".content-route").classList.remove("hidden");
  document.querySelector(".content-d1").style.display="block";
...
const truck=document.querySelector(".fa-truck-moving");
...
truck.addEventListener("click",openAddModal);
